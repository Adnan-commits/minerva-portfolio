...
![Research Input](./docs/screenshots/userinput.png)

![Processing](./docs/screenshots/processing.png)

![Research Output](./docs/screenshots/research_output.png)

![Research PDF Mode](./docs/screenshots/research_pdfmode.png)

![Output Markdown](./docs/screenshots/output_md.png)

![Output PDF](./docs/screenshots/output_pdf.png)

![Output JSON](./docs/screenshots/output_json.png)

![Capabilities](./docs/screenshots/capabilities.png)
